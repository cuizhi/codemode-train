...
bool serial_out(uint8_t chByte)
{ 
    if(SET != USART_GetFlagStatus(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)),((uint16_t)0x0040))){
        return false;
    }
    USART_SendData(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)),chByte);
...
bool serial_in(uint8_t *pchByte)
{
    ...
    if(SET == USART_GetFlagStatus(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)), ((uint16_t)0x0020))){
        *pchByte = USART_ReceiveData(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)));
        return true;
    }else{
        return false;
    }
